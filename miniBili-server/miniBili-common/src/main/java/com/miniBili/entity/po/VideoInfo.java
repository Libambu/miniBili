...
public class VideoInfo implements Serializable {
	...
	public String toString (){
		return "视频id:"+(videoId == null ? "空" : videoId)+"，视频封面:"+(videoCover == null ? "空" : videoCover)+"，视频名称:"+(videoName == null ? "空" : videoName)+"，用户id:"+(userId == null ? "空" : userId)+"，创建时间:"+(createTime == null ? "空" : DateUtil.format(createTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()))+"，最后更新时间:"+(lastUpdateTime == null ? "空" : DateUtil.format(lastUpdateTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()))+"，父级分类id:"+(pCategoryId == null ? "空" : pCategoryId)+"，分类id:"+(categoryId == null ? "空" : categoryId)+"，0自制作1转载:"+(postType == null ? "空" : postType)+"，原资源说明:"+(originInfo == null ? "空" : originInfo)+"，标签:"+(tags == null ? "空" : tags)+"，简介:"+(introduction == null ? "空" : introduction)+"，互动设置:"+(interaction == null ? "空" : interaction)+"，持续时间:"+(duration == null ? "空" : duration)+"，播放量:"+(playCount == null ? "空" : playCount)+"，点赞量:"+(likeCount == null ? "空" : likeCount)+"，弹幕数量:"+(danmuCount == null ? "空" : danmuCount)+"，评论数量:"+(commentCount == null ? "空" : commentCount)+"，硬币数:"+(coinCount == null ? "空" : coinCount)+"，收藏数:"+(collectCount == null ? "空" : collectCount)+"，是否推荐 0未推荐1已推荐:"+(recommendType == null ? "空" : recommendType)+"，最后播放时间:"+(lastPlayTime == null ? "空" : DateUtil.format(lastPlayTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()));
	}
}
