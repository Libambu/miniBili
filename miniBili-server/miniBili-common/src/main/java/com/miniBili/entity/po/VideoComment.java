...
public class VideoComment implements Serializable {
	...
	public String toString (){
		return "评论id:"+(commentId == null ? "空" : commentId)+"，父级评论id:"+(pCommentId == null ? "空" : pCommentId)+"，视频id:"+(videoId == null ? "空" : videoId)+"，视频用户id:"+(videoUserId == null ? "空" : videoUserId)+"，回复内容:"+(content == null ? "空" : content)+"，图片:"+(imgPath == null ? "空" : imgPath)+"，用户id:"+(userId == null ? "空" : userId)+"，回复人id:"+(replyUserId == null ? "空" : replyUserId)+"，0未置顶1置顶:"+(topType == null ? "空" : topType)+"，发布时间:"+(postTime == null ? "空" : DateUtil.format(postTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()))+"，喜欢数量:"+(likeCount == null ? "空" : likeCount)+"，讨厌数量:"+(hateCount == null ? "空" : hateCount);
	}
}
