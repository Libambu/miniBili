...
public interface StatisticsInfoService {
	 ...
	 */
	StatisticsInfo getStatisticsInfoByStatisticsDateAndUserIdAndDataType(Date statisticsDate, String userId, Integer dataType);


	/**
	 * 根据StatisticsDateAndUserIdAndDataType修改
	 */
	Integer updateStatisticsInfoByStatisticsDateAndUserIdAndDataType(StatisticsInfo bean,Date statisticsDate,String userId,Integer dataType);
