...
@Validated
@Slf4j
public class UcenterStatisticController extends ABaseController{
    @Autowired
    ...
    public ResponseVO getActualTimeStatisticsInfo(){
        ...
        statisticsInfoQuery.setUserId(tokenInfoDto.getUserId());
        ...
        //还要把各种类型总的数据也查出来
        Map<String,Integer>totalStatistic = statisticsInfoService.getStatisticsInfoALL(tokenInfoDto.getUserId());
    ...
    public ResponseVO getWeekStatisticsInfo(Integer dataType){
        ...
        for(String data : dataList){
            ...
            statisticsInfoDto.setUserId(tokenInfoDto.getUserId());
            if(item!=null){
